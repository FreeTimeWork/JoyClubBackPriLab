...
CREATE TABLE `card_coupon_launch` (
  ...
  `pay_type` tinyint(4) NOT NULL DEFAULT '2' COMMENT '支付方式 1,金钱 2,积分,默认积分',
  `pay_amount` decimal(14,4) NOT NULL DEFAULT '0.0000' COMMENT '支付值 0代表免费，默认为免费',
...
CREATE TABLE `card_coupon_order` (
  ...
  `out_pay_code` varchar(64) DEFAULT NULL COMMENT '支付成功的外部单号',
  `project_id` bigint(20) NOT NULL COMMENT '项目id',
