...
import com.joycity.joyclub.commons.excel.ExportExcelField;
import com.joycity.joyclub.commons.excel.ExportExcelFile;
import com.joycity.joyclub.commons.excel.ExportExcelSheet;
...
public class ExcelUtility {
	...
	public static String getExportExcelSheetName(Field field, ExportExcelSheet exportExcelSheet) {
		String sheetName = exportExcelSheet.sheetName();
	...
	public static String getExportExcelFileName(Class<?> clazz, String userAgent) {
		String fileName = clazz.getSimpleName();
		
		ExportExcelFile exportExcelFile = clazz.getAnnotation(ExportExcelFile.class);
		if (exportExcelFile != null && !StringUtils.isEmpty(exportExcelFile.fileName())) {
			fileName = exportExcelFile.fileName();
		}
		
		return encodeFileName(getExportExcelFileName(
				fileName, System.currentTimeMillis()), userAgent);
	}
	
    public static String getExportExcelFileName(Object... elements) {
    	return StringUtility.getConcatString("_", elements) + ".xls";
    }
    ...
    public static CellStyle getCellStyle(HSSFWorkbook workbook, CrudType crudType, Boolean available) {
