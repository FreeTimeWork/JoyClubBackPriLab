...
public interface ActMapper extends BaseMapperWithBLOBS<SaleAct, SaleActWithBLOBs, Long, SaleActExample> {
    //////////////////////////api back//////////////////
    Long countByStoreIdAndName(@Param("effective")Boolean effective,@Param("projectId") Long projectId, @Param("nameLike") String nameLike, @Param("pageUtil") PageUtil pageUtil);

    List<ActWithCategoryName> selectByStoreIdAndName(@Param("effective")Boolean effective,@Param("projectId") Long projectId, @Param("nameLike") String nameLike, @Param("pageUtil") PageUtil pageUtil);
